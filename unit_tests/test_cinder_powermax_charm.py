...
import unittest
from src.charm import CinderPowerMaxCharm
from ops.model import ActiveStatus
from ops.testing import Harness


class TestCinderPowerMaxCharm(unittest.TestCase):

    def setUp(self):
        self.harness = Harness(CinderPowerMaxCharm)
    ...
    def test_base(self):
        ...
        self.assertTrue(
            isinstance(self.harness.model.unit.status, ActiveStatus)
        )

    def test_configuration(self):
        test_config = {
            'volume-backend-name': 'cinder_powermax_test',
            'san-ip': '10.0.0.11',
            'san-login': 'username',
